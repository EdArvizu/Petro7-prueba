function CPreloader() {
    ...
    this.attachSprites = function () {
        ...
        oBg.graphics.beginFill("#007853").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/2, oSprite, TEXT_PRELOADER_CONTINUE, "Arial", "white", "bold "+ 50, _oContainer);        
        _oButStart.addEventListener(ON_MOUSE_UP, this._onButStartRelease, this);
        _oButStart.setVisible(false);
        
        _oFade = new createjs.Shape();
        _oFade.graphics.beginFill("#007853").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
